...
const VerifyCode = () => {
    ...
    const handleSetnewPassword =  async (e) => {
      ...
      console.log("sdfkhaksjldfhkjlasdf");
        ...
        try {
            const response = await axios.post("http://127.0.0.1:8080/verifyOtp", {email: location.state?.email, otpNumber: otp});
          ...
          <Form className="form-container">
            <Form.Group controlId="formEmail" className="mb-4">
              ...
              <div className="input-icon">
                ...
                <Form.Control onChange={(e)=> setOtp(e.target.value)} placeholder="Enter OTP" />
              </div>
              <button className="signin-button" onClick={handleSetnewPassword} >Verify</button>
