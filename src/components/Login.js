      ...
      <Row className="h-100">
        ...
        <Col md={6} className="left-section d-flex flex-column align-items-center justify-content-center">
          ...
          <Form className="form-container">
            ...
            <button className="signin-button" onClick={submitForm(handleSubmit)}>Login</button>
            <FormGroup className="signup-checkbox-group">
                <Label check className="signup-checkbox-label">
                    <span className="signup-text">Don’t have an account? <a href="/signup" className="signup-link">Sign up now</a></span>
            </Label>
                </FormGroup>
